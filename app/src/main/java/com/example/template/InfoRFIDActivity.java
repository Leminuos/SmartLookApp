...
public class InfoRFIDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_rfid_activity);
    ...
    private void initUi() {
        ...
        dataRef = FirebaseDatabase.getInstance().getReference().child("RFID");
            ...
            public void onClick(View v) {
                ...
                if(newName.equals(""))
                {
                    if(!isShowingErrorMessage) {
                        Toast.makeText(InfoRFIDActivity.this, "Vui lòng nhập tên bạn muốn thay đổi",
                    ...
                    if(!isShowingErrorMessage) {
                        Toast.makeText(InfoRFIDActivity.this, "Tên mới trùng với tên cũ. Vui lòng nhập lại!",
                                Toast.LENGTH_SHORT).show();
                        isShowingErrorMessage = true;
                        handler.postDelayed(new Runnable() {
                            @Override
                ...
                if(!isShowingErrorMessage) {
                    Toast.makeText(InfoRFIDActivity.this, "Đã thay đổi " + info.name + " thành " + newName,
                            Toast.LENGTH_SHORT).show();
                    isShowingErrorMessage = true;
                    handler.postDelayed(new Runnable() {
                        @Override
    ...
    private void openConfirmDialog(int position, String ID) {
        View view = LayoutInflater.from(InfoRFIDActivity.this).inflate(R.layout.confirm_layout, null);
        AlertDialog.Builder confirm = new AlertDialog.Builder(InfoRFIDActivity.this);
            ...
            public void onClick(View v) {
                ...
                dataRef.child(ID).removeValue(new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(DatabaseError error, DatabaseReference ref) {
                        Toast.makeText(InfoRFIDActivity.this, "Đã xoá ID " + ID + " thành công.",
                                Toast.LENGTH_SHORT).show();
                    }
                });
